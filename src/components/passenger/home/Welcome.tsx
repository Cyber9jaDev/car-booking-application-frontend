import {  Banknote,  Users,  Car,  Settings,  SmilePlus,  BusFront } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="mb-5 md:mb-0">
              <h4 className="mb-4 text-left leading-9 text-base text-black font-semibold tracking-wider uppercase">
                Lorem ipsum dolor sit amet, In consectetur adipiscing elit. Etiam commodo urna dolor,
              </h4>
              <Link 
            ...
            <div>
              <p className="text-base leading-8 text-left text-gray-700">
                Lorem ipsum dolor sit init amet, consectetur elit adipiscing elit. Etiam commodo urna dolor, eget lacinia
                est aliquam id. Proin velit libero, vestibul umac orci eu, faucibus consectetur dolor. Cras ullamcorper
                elit eros, nec bibendum lacus accumsan eu. Donec non
              </p>
            </div>
